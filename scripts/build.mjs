...
await build({entryPoints:['src/admin.mjs'],bundle:true,minify:true,format:'esm',outfile:'public/admin.js',target:'es2022'});
...
await build({entryPoints:['src/navigation-worker.mjs'],bundle:true,minify:true,format:'esm',outfile:'public/navigation-worker.js',target:'es2022'});
