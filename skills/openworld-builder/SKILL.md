...
Use the server the user selected or the server in their existing CLI session. Do not invent a production domain. The local development default is http://127.0.0.1:8787 and requires a running local server.
